...
def home_page(frame):
    ...
    if is_table_exist("FILE") == 0 or is_table_empty("FILE"):
...
def load_page(frame):
    ...
    for item in data:
        ...
        file_delete_command = Button(file_item_frame, text="Delete", command=lambda rowid=rowid, pos=item[3]: delete(rowid, pos))
